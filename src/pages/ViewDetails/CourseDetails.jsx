        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <section>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <p className="text-gray-700 mb-2">• 8 sections • 150+ lectures • 200+ hours total length</p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  having helped 5000+ students crack CAT with 99+ percentile. 
                  His unique teaching methodology focuses on conceptual clarity and exam strategy.
                </p>
              </div>
            </motion.div>
          </section>
